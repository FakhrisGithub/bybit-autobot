...
# ENTRY FILTER
# ======================================
MIN_SCORE_TO_ENTRY = 70           # testnet: turunkan ke 70 untuk verifikasi mekanis entry/exit
                                   # WAJIB naikkan kembali ke 80 sebelum pindah ke live
REQUIRE_VOL_OK      = False       # testnet: matikan filter vol untuk verifikasi mekanis
                                   # WAJIB set ke True sebelum live
...
# ======================================
EXCLUDE_SYMBOLS = [
    # Simbol tidak ada data kline di testnet (saham tokenized dll)
    "100000TSTSATSUSDT", "AAPLUSDT", "AIGENSYNUSDT", "AMZNUSDT", "BILLUSDT",
    "COINUSDT", "CRCLUSDT", "DELLUSDT", "GOOGLUSDT", "INTCUSDT", "MSTRUSDT",
    "OPNUSDT", "PLTRUSDT",
    # Simbol restricted 10024 (restriksi regional Bybit untuk user Indonesia)
    "COHRUSDT", "FLNCUSDT", "IRENUSDT", "ONDSUSDT", "AXTIUSDT",
]
...
# simbol di testnet. Pakai 0 untuk testnet/demo (semua simbol masuk), threshold
# realistis untuk live supaya hindari coin illikuid.
MIN_TURNOVER_24H_USDT = 1_000_000.0 if LIVE else 0.0
